...
Below, we have provided instructions for downloading the data that will be used to identify underserved communities in Tampa Bay. To view instructions for cleaning the data and utilizing the socioeconomic indices to map underserved communities, see "Mapping underserved communities".
