...
We have created this webpage to increase transparency and reproducibility of the approach guiding our Equity Strategy. We have provided instructions for downloading, cleaning, and analyzing the data that will be used to identify underserved and overburdened communities in Tampa Bay. The methods described on the subsequent pages are presented in [R](https://www.r-project.org/) coding language, but users who prefer working with GIS software (e.g., [ArcGIS](https://www.esri.com/en-us/arcgis/about-arcgis/overview){target="_blank"} or [QGIS](https://www.qgis.org/en/site/){target="_blank"}) should also be able to reproduce the maps by following along in the descriptions of each step.
