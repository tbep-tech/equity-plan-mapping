...
underserved_tract %>%
  ...
  mapview(col.regions = "red", layer.name = "Underserved Tracts")
```
...
under_over %>%
  mapview(zcol = "thresholdEJ_N", col.regions = brewer.pal(8, "YlOrRd"), layer.name = "No. of Burdens", label = "thresholdEJ_N")
```
